...
\usepackage[toc, acronym, nonumberlist, nopostdot]{glossaries} % Used for abbreviations
\makeglossaries
...
\ifnum \numsupervisors=1
    \supervisor{\phdsupervisors}
\else
    \supervisors{\phdsupervisors}
\fi
...
\input{Information/Declaration.tex}
...
%Abbreviations
\input{Information/Abbreviations.tex}
...
\clearpage 
\input{Information/Dedication.tex} % Abbreviations
